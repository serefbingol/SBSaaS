        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtcDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_i18n_translations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UiCulture = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_change_log_Operation",
                schema: "audit",
                table: "change_log",
                column: "Operation");

            migrationBuilder.CreateIndex(
                name: "IX_change_log_TableName_UtcDate",
                schema: "audit",
                table: "change_log",
                columns: new[] { "TableName", "UtcDate" });

            migrationBuilder.CreateIndex(
                name: "IX_change_log_TenantId_UtcDate",
                schema: "audit",
                table: "change_log",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_i18n_translations_Key_Culture",
