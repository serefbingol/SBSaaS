...
{
    (string accessToken, string refreshToken, DateTimeOffset expires) Issue(ApplicationUser user, IEnumerable<string> roles);
}
...
public class TokenService : ITokenService
{
    ...
    public (string accessToken, string refreshToken, DateTimeOffset expires) Issue(ApplicationUser user, IEnumerable<string> roles)
    {
